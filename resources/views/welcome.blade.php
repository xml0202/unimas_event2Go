            ...
            <div class="mt-16">
                <div class="row">
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Access Token</h2>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Introspect token
                                </h2>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    {{-- {{ json_decode($introspect, true) }} --}}
                                    {{ $introspect }}
                                </p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">User Info</h2>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
