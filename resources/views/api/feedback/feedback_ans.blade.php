                            ...
                            <br/><br/><table class="table table-hover table-border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Kesesuaian-1" name="Kesesuaian" class="custom-control-input" value="1" <?php echo is_checked($q1ans2, "1") ?> disabled>
                                                <label class="custom-control-label" for="Kesesuaian-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Kesesuaian-2" name="Kesesuaian" class="custom-control-input" value="2" <?php echo is_checked($q1ans2, "2") ?> disabled>
                                                <label class="custom-control-label" for="Kesesuaian-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Kesesuaian-3" name="Kesesuaian" class="custom-control-input" value="3" <?php echo is_checked($q1ans2, "3") ?> disabled>
                                                <label class="custom-control-label" for="Kesesuaian-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Kesesuaian-4" name="Kesesuaian" class="custom-control-input" value="4" <?php echo is_checked($q1ans2, "4") ?> disabled>
                                                <label class="custom-control-label" for="Kesesuaian-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Kesesuaian-5" name="Kesesuaian" class="custom-control-input" value="5" <?php echo is_checked($q1ans2, "5") ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="diperuntukkan-1" name="diperuntukkan" class="custom-control-input" value="1" <?php echo is_checked($q1ans3, "1") ?> disabled>
                                                <label class="custom-control-label" for="diperuntukkan-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="diperuntukkan-2" name="diperuntukkan" class="custom-control-input" value="2" <?php echo is_checked($q1ans3, "2") ?> disabled>
                                                <label class="custom-control-label" for="diperuntukkan-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="diperuntukkan-3" name="diperuntukkan" class="custom-control-input" value="3" <?php echo is_checked($q1ans3, "3") ?> disabled>
                                                <label class="custom-control-label" for="diperuntukkan-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="diperuntukkan-4" name="diperuntukkan" class="custom-control-input" value="4" <?php echo is_checked($q1ans3, "4") ?> disabled>
                                                <label class="custom-control-label" for="diperuntukkan-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="diperuntukkan-5" name="diperuntukkan" class="custom-control-input" value="5" <?php echo is_checked($q1ans3, "5") ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="modul-1" name="modul" class="custom-control-input" value="1" <?php echo is_checked($q1ans4, "1") ?> disabled>
                                                <label class="custom-control-label" for="modul-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="modul-2" name="modul" class="custom-control-input" value="2" <?php echo is_checked($q1ans4, "2") ?> disabled>
                                                <label class="custom-control-label" for="modul-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="modul-3" name="modul" class="custom-control-input" value="3" <?php echo is_checked($q1ans4, "3") ?> disabled>
                                                <label class="custom-control-label" for="modul-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="modul-4" name="modul" class="custom-control-input" value="4" <?php echo is_checked($q1ans4, "4") ?> disabled>
                                                <label class="custom-control-label" for="modul-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="modul-5" name="modul" class="custom-control-input" value="5" <?php echo is_checked($q1ans4, "5") ?> disabled>
                            ...
                            <table class="table table-hover table-border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Interaksi-1" name="Interaksi" class="custom-control-input" value="1" <?php echo is_checked($q2ans4, "1") ?> disabled>
                                                <label class="custom-control-label" for="Interaksi-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Interaksi-2" name="Interaksi" class="custom-control-input" value="2" <?php echo is_checked($q2ans4, "2") ?> disabled>
                                                <label class="custom-control-label" for="Interaksi-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Interaksi-3" name="Interaksi" class="custom-control-input" value="3" <?php echo is_checked($q2ans4, "3") ?> disabled>
                                                <label class="custom-control-label" for="Interaksi-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Interaksi-4" name="Interaksi" class="custom-control-input" value="4" <?php echo is_checked($q2ans4, "4") ?> disabled>
                                                <label class="custom-control-label" for="Interaksi-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Interaksi-5" name="Interaksi" class="custom-control-input" value="5" <?php echo is_checked($q2ans4, "5") ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Persediaan-1" name="Persediaan" class="custom-control-input" value="1" <?php echo is_checked($q2ans5, "1") ?> disabled>
                                                <label class="custom-control-label" for="Persediaan-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Persediaan-2" name="Persediaan" class="custom-control-input" value="2" <?php echo is_checked($q2ans5, "2") ?> disabled>
                                                <label class="custom-control-label" for="Persediaan-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Persediaan-3" name="Persediaan" class="custom-control-input" value="3" <?php echo is_checked($q2ans5, "3") ?> disabled>
                                                <label class="custom-control-label" for="Persediaan-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Persediaan-4" name="Persediaan" class="custom-control-input" value="4" <?php echo is_checked($q2ans5, "4") ?> disabled>
                                                <label class="custom-control-label" for="Persediaan-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Persediaan-5" name="Persediaan" class="custom-control-input" value="5" <?php echo is_checked($q2ans5, "5") ?> disabled>
                            ...
                            <table class="table table-hover table-border">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Pengurusan-1" name="Pengurusan" class="custom-control-input" value="1" <?php echo is_checked($q3ans1, "1") ?> disabled>
                                                <label class="custom-control-label" for="Pengurusan-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Pengurusan-2" name="Pengurusan" class="custom-control-input" value="2" <?php echo is_checked($q3ans1, "2") ?> disabled>
                                                <label class="custom-control-label" for="Pengurusan-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Pengurusan-3" name="Pengurusan" class="custom-control-input" value="3" <?php echo is_checked($q3ans1, "3") ?> disabled>
                                                <label class="custom-control-label" for="Pengurusan-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Pengurusan-4" name="Pengurusan" class="custom-control-input" value="4" <?php echo is_checked($q3ans1, "4") ?> disabled>
                                                <label class="custom-control-label" for="Pengurusan-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="Pengurusan-5" name="Pengurusan" class="custom-control-input" value="5" <?php echo is_checked($q3ans1, "5") ?> disabled>
                            ...
                            <table class="table table-hover table-border">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="masyarakat-1" name="masyarakat" class="custom-control-input" value="1" <?php echo is_checked($q4ans1, "1") ?> disabled>
                                                <label class="custom-control-label" for="masyarakat-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="masyarakat-2" name="masyarakat" class="custom-control-input" value="2" <?php echo is_checked($q4ans1, "2") ?> disabled>
                                                <label class="custom-control-label" for="masyarakat-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="masyarakat-3" name="masyarakat" class="custom-control-input" value="3" <?php echo is_checked($q4ans1, "3") ?> disabled>
                                                <label class="custom-control-label" for="masyarakat-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="masyarakat-4" name="masyarakat" class="custom-control-input" value="4" <?php echo is_checked($q4ans1, "4") ?> disabled>
                                                <label class="custom-control-label" for="masyarakat-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="masyarakat-5" name="masyarakat" class="custom-control-input" value="5" <?php echo is_checked($q4ans1, "5") ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="manfaat-1" name="manfaat" class="custom-control-input" value="1" <?php echo is_checked($q4ans2, "1") ?> disabled>
                                                <label class="custom-control-label" for="manfaat-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="manfaat-2" name="manfaat" class="custom-control-input" value="2" <?php echo is_checked($q4ans2, "2") ?> disabled>
                                                <label class="custom-control-label" for="manfaat-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="manfaat-3" name="manfaat" class="custom-control-input" value="3" <?php echo is_checked($q4ans2, "3") ?> disabled>
                                                <label class="custom-control-label" for="manfaat-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="manfaat-4" name="manfaat" class="custom-control-input" value="4" <?php echo is_checked($q4ans2, "4") ?> disabled>
                                                <label class="custom-control-label" for="manfaat-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="manfaat-5" name="manfaat" class="custom-control-input" value="5" <?php echo is_checked($q4ans2, "5") ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mencadangkan-1" name="mencadangkan" class="custom-control-input" value="1" <?php echo is_checked($q4ans3, "1") ?> disabled>
                                                <label class="custom-control-label" for="mencadangkan-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mencadangkan-2" name="mencadangkan" class="custom-control-input" value="2" <?php echo is_checked($q4ans3, "2") ?> disabled> 
                                                <label class="custom-control-label" for="mencadangkan-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mencadangkan-3" name="mencadangkan" class="custom-control-input" value="3" <?php echo is_checked($q4ans3, "3") ?> disabled>
                                                <label class="custom-control-label" for="mencadangkan-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mencadangkan-4" name="mencadangkan" class="custom-control-input" value="4" <?php echo is_checked($q4ans3, "4") ?> disabled>
                                                <label class="custom-control-label" for="mencadangkan-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mencadangkan-5" name="mencadangkan" class="custom-control-input" value="5" <?php echo is_checked($q4ans3, "5") ?> disabled>
                    ...
                    <tr>
                        <div class="table-responsive">
                            ...
                            <label for="fname">Bagaimana latihan ini dapat menyumbang ke arah peningkatan kerja-kerja anda pada masa hadapan?</label><br>
                             <textarea name="Text1" cols="150" rows="5" disabled> <?php echo $q5ans1 ?> </textarea><br><br>
                        </div>
                    </tr>
                    ...
                    <tr>
                        <div class="table-responsive">
                            <label for="fname">Cadangan lain, komen dan sebagainya.</label><br>
                             <textarea name="Text2" cols="150" rows="5" disabled> <?php echo $q6ans1 ?> </textarea><br><br>
                        </div>
                    </tr>    
                </ul>
