        ...
        <div class="container mt-2">
            <div class="card">
                <div class="card-body" style="-webkit-box-flex: 1;-ms-flex: 1 1 auto;flex: 1 1 auto;padding: 1.25rem;">
                    ...
                    <p class="card-text">Kami ingin tahu sejauh mana produk ini telah memenuhi jangkaan anda.Penilaiaan ini akan membantu kami untuk meningkatkan mutu pembangunan produk di masa akan datang. Maklumbalas anda amat dihargai.</p>
                ...
                <ul class="list-group list-group-flush">
                   ...
                   <li class="list-group-item">
                        <div class="table-responsive">
                            <label class="mb-0">I.	PRODUK (1 = Sangat Tidak Memuaskan, 5 = Sangat Memuaskan)</label>
                            ...
                            <br/><br/><table class="table table-hover table-border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="kepuasan-1" name="kepuasan" class="custom-control-input" value="1" required>
                                                <label class="custom-control-label" for="kepuasan-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="kepuasan-2" name="kepuasan" class="custom-control-input" value="2" required>
                                                <label class="custom-control-label" for="kepuasan-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="kepuasan-3" name="kepuasan" class="custom-control-input" value="3" required>
                                                <label class="custom-control-label" for="kepuasan-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="kepuasan-4" name="kepuasan" class="custom-control-input" value="4" required>
                                                <label class="custom-control-label" for="kepuasan-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="kepuasan-5" name="kepuasan" class="custom-control-input" value="5" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mesra-1" name="mesra" class="custom-control-input" value="1" required>
                                                <label class="custom-control-label" for="mesra-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mesra-2" name="mesra" class="custom-control-input" value="2" required>
                                                <label class="custom-control-label" for="mesra-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mesra-3" name="mesra" class="custom-control-input" value="3" required>
                                                <label class="custom-control-label" for="mesra-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mesra-4" name="mesra" class="custom-control-input" value="4" required>
                                                <label class="custom-control-label" for="mesra-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="mesra-5" name="mesra" class="custom-control-input" value="5" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="urusan-1" name="urusan" class="custom-control-input" value="1" required>
                                                <label class="custom-control-label" for="urusan-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="urusan-2" name="urusan" class="custom-control-input" value="2" required>
                                                <label class="custom-control-label" for="urusan-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="urusan-3" name="urusan" class="custom-control-input" value="3" required>
                                                <label class="custom-control-label" for="urusan-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="urusan-4" name="urusan" class="custom-control-input" value="4" required>
                                                <label class="custom-control-label" for="urusan-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="urusan-5" name="urusan" class="custom-control-input" value="5" required>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="dibaiki-1" name="dibaiki" class="custom-control-input" value="1" required>
                                                <label class="custom-control-label" for="dibaiki-1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="dibaiki-2" name="dibaiki" class="custom-control-input" value="2" required>
                                                <label class="custom-control-label" for="dibaiki-2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="dibaiki-3" name="dibaiki" class="custom-control-input" value="3" required>
                                                <label class="custom-control-label" for="dibaiki-3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="dibaiki-4" name="dibaiki" class="custom-control-input" value="4" required>
                                                <label class="custom-control-label" for="dibaiki-4"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="dibaiki-5" name="dibaiki" class="custom-control-input" value="5" required>
